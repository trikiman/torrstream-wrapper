...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = E:/Projects/torrserver/.codex
                  → checks E:/Projects/torrserver/.codex/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = E:/Projects/torrserver/.codex/get-shit-done
                  → writes to E:/Projects/torrserver/.codex/get-shit-done/hooks/
...
```bash
INIT=$(node "E:/Projects/torrserver/.codex/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "E:/Projects/torrserver/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "E:/Projects/torrserver/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
