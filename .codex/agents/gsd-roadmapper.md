...
Reference full template: `E:/Projects/torrserver/.codex/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `E:/Projects/torrserver/.codex/get-shit-done/templates/state.md`.
