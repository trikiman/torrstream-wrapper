...
<reference>
@E:/Projects/torrserver/.codex/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `E:/Projects/torrserver/.codex/get-shit-done/references/user-profiling.md` to load:
