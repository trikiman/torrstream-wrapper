...
Use template from `E:/Projects/torrserver/.codex/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `E:/Projects/torrserver/.codex/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "E:/Projects/torrserver/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
