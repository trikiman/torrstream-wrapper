...
<!-- For checkpoint task examples and patterns, see @E:/Projects/torrserver/.codex/get-shit-done/references/checkpoints.md -->
...
See `E:/Projects/torrserver/.codex/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `E:/Projects/torrserver/.codex/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `E:/Projects/torrserver/.codex/get-shit-done/workflows/verify-phase.md` for verification logic.
