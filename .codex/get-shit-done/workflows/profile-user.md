...
Key references:
- @E:/Projects/torrserver/.codex/get-shit-done/references/ui-brand.md (display patterns)
- @E:/Projects/torrserver/.codex/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @E:/Projects/torrserver/.codex/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="E:/Projects/torrserver/.codex/get-shit-done/USER-PROFILE.md"
...
```bash
cp "E:/Projects/torrserver/.codex/get-shit-done/USER-PROFILE.md" "E:/Projects/torrserver/.codex/get-shit-done/USER-PROFILE.backup.md"
```
...
✓ Stores profile at E:/Projects/torrserver/.codex/get-shit-done/USER-PROFILE.md
...
Run session scan:
```bash
SCAN_RESULT=$(node E:/Projects/torrserver/.codex/get-shit-done/bin/gsd-tools.cjs scan-sessions --json 2>/dev/null)
```
...
```bash
SAMPLE_RESULT=$(node E:/Projects/torrserver/.codex/get-shit-done/bin/gsd-tools.cjs profile-sample --json 2>/dev/null)
```
...
- The user-profiling reference doc at `E:/Projects/torrserver/.codex/get-shit-done/references/user-profiling.md`
...
Reference: @E:/Projects/torrserver/.codex/get-shit-done/references/user-profiling.md
...
**Get questions:**
```bash
QUESTIONS=$(node E:/Projects/torrserver/.codex/get-shit-done/bin/gsd-tools.cjs profile-questionnaire --json 2>/dev/null)
```
...
```bash
ANALYSIS_RESULT=$(node E:/Projects/torrserver/.codex/get-shit-done/bin/gsd-tools.cjs profile-questionnaire --answers "$ANSWERS_PATH" --json 2>/dev/null)
```
...
```bash
node E:/Projects/torrserver/.codex/get-shit-done/bin/gsd-tools.cjs write-profile --input "$ANALYSIS_PATH" --json 2>/dev/null
```

Display: "✓ Profile written to E:/Projects/torrserver/.codex/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to E:/Projects/torrserver/.codex/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at E:/Projects/torrserver/.codex/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
```bash
node E:/Projects/torrserver/.codex/get-shit-done/bin/gsd-tools.cjs generate-dev-preferences --analysis "$ANALYSIS_PATH" --json 2>/dev/null
```

Display: "✓ Generated /gsd-dev-preferences at E:/Projects/torrserver/.codex/commands/gsd/dev-preferences.md"

**For AGENTS.md profile section (if selected):**

```bash
node E:/Projects/torrserver/.codex/get-shit-done/bin/gsd-tools.cjs generate-claude-profile --analysis "$ANALYSIS_PATH" --json 2>/dev/null
```
...
```bash
node E:/Projects/torrserver/.codex/get-shit-done/bin/gsd-tools.cjs generate-claude-profile --analysis "$ANALYSIS_PATH" --global --json 2>/dev/null
```

Display: "✓ Added profile section to E:/Projects/torrserver/.codex/AGENTS.md"
...
```bash
BACKUP_PATH="E:/Projects/torrserver/.codex/get-shit-done/USER-PROFILE.backup.md"
```
...
Your profile:    E:/Projects/torrserver/.codex/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   E:/Projects/torrserver/.codex/commands/gsd/dev-preferences.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        E:/Projects/torrserver/.codex/AGENTS.md
```
