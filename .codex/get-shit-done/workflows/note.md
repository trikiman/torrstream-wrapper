...
- **Global scope**: `E:/Projects/torrserver/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `E:/Projects/torrserver/.codex/notes/`)
...
2. Glob `E:/Projects/torrserver/.codex/notes/*.md` (if directory exists) — global notes
...
Global (E:/Projects/torrserver/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `E:/Projects/torrserver/.codex/notes/` — works in any directory
